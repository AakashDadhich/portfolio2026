...
export const projects = [
  {
    ...
    fullDesc: [
      "I was tired of manually trawling through a dozen news sites to keep up with the topics I care about most - technology, cars, and world news - so I built Recon RSS to handle it automatically. Using Claude Code as my development environment throughout, the bot lets you subscribe to RSS feeds and route them to channels of your choice within your own Discord server, polling every five minutes and posting new articles as formatted embeds with no manual intervention needed.",
